                                        ...
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                    ...
                                                    <SelectContent>
                                                        {categoryData && ((categoryData.category && categoryData.category.length > 0) || (categoryData.categories && categoryData.categories.length > 0)) &&
                                                            ((categoryData.category || categoryData.categories).map(category => (
