...
const LikeCount = ({ props }) => {
    ...
    if (!user || !user.user) {
        return null; // or a message like "Log in to like"
    }

    const { data: blogLikeCount, loading, error } = useFetch(`${getEnv('VITE_API_BASE_URL')}/blog-like/get-like/${props.blogid}/${user && user.user._id ? user.user._id : ''}`, {
        method: 'get',
        credentials: 'include',
    })
